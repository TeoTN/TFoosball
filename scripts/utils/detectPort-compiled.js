...
var inject = function inject(port) {
...
function detect(port, fn) {
  ...
  var _detect = function _detect(port) {
  ...
  var _detect_with_cb = function _detect_with_cb(_fn) {
    _detect(port).then(function (result) {
      _fn(null, result);
    }).catch(function (e) {
      _fn(e);
    });
...
//# sourceMappingURL=detectPort-compiled.js.map