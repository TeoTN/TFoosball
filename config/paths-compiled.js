...
var isEjected = path.resolve(path.join(__dirname, '..')) === path.resolve(process.cwd());

// Are we developing create-react-app locally?
var isInCreateReactAppSource = process.argv.some(function (arg) {
  return arg.indexOf('--debug-template') > -1;
});
...
//# sourceMappingURL=paths-compiled.js.map